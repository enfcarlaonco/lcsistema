-- Migration: tabela de responsáveis por ação + enum de agentes
-- Execute: npx prisma db execute --file prisma/migration_acoes_responsaveis.sql

CREATE TYPE "AgenteResponsavel" AS ENUM (
  'ADMINISTRATIVO',
  'MEDICO',
  'ENFERMAGEM',
  'GESTAO',
...
-- Adiciona coluna de histórico de atualizações na ação
